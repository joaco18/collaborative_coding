...
def main():
    ...
    cfg_path = experiments_path / 'test_config.yaml'
    ...
    logging.info('Starting runs on test set...')
    for case_idx in tqdm(range(len(test_dataset))):
        case = test_dataset[case_idx]
        ...
        model = ExpectationMaximization(
            ...
            tissue_models=test_dataset.tissue_models,
    ...
    with open(str(results_path / 'checkpoint.pkl'), 'wb') as pkl_file:
        update = {'cfg': cfg, 'tissue_models': test_dataset.tissue_models}
